(function() {
    ...
    if (s !== null) {
        var l = s.querySelector("#createWalletForm");
        ...
        // Validation for Step 1 (Required)
        ...
        // Validation for Step 2 (Optional)
        let t = FormValidation.formValidation(d, {
            fields: {
                // Optional validation can be defined here
            },
            plugins: {
                trigger: new FormValidation.plugins.Trigger(),
                bootstrap5: new FormValidation.plugins.Bootstrap5({
        ...
        // Validation for Step 3 (Optional)
        ...
        // Validation for Step 4 (Optional)
        ...
        // Final Step (Review) - No specific validation
