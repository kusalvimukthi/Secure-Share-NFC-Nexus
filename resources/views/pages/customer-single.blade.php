...
{{--                                                            <i class="bx bx-map me-2 align-top"></i><span class="fw-medium">@if(Auth::user()->userDetail){{Auth::user()->userDetail->address}}@else N/A @endif</span>--}}
{{--                                                        </li>--}}
{{--                                                        <li class="list-inline-item">--}}
                                ...
                                <div class="card">
                                    <div class="card-header pb-4">
                                        <div class="d-flex align-items-center justify-content-between">
                                            <div class="me-2">
                                                <h5 class="mb-0 text-heading">Business Card</h5>
                                            </div>
                                    ...
                                    <div class="card-body border-top">
                                        <div class="d-flex align-items-center justify-content-center">
                                            <a href="/business-card/{{$card->id}}" class="btn btn-primary d-flex align-items-center me-4"><i class='bx bx-show-alt bx-sm me-2'></i>view Business Card</a>
                                        </div>
                                    </div>
