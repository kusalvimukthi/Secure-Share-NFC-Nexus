...
<script type="text/javascript" src="{{asset('assets/master_ui/js/business-card-validation.js')}}"></script>
<script type="text/javascript" src="{{asset('assets/master_ui/js/custom-tag-validation.js')}}"></script>
<script type="text/javascript" src="{{asset('assets/master_ui/js/storage-tag-validation.js')}}"></script>
<script type="text/javascript" src="{{asset('assets/master_ui/js/pet-tag-validation.js')}}"></script>
