...
<script type="text/javascript" src="{{asset('assets/master_ui/js/business-card-update-validation.js')}}"></script>
<script type="text/javascript" src="{{asset('assets/master_ui/js/custom-tag-update-validation.js')}}"></script>
<script type="text/javascript" src="{{asset('assets/master_ui/js/pet-tag-update-validation.js')}}"></script>
<script type="text/javascript" src="{{asset('assets/master_ui/js/storage-tag-update-validation.js')}}"></script>
