        ...
        <div class="authentication-inner py-4">
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <form id="passwordResetForm" class="mb-3">
                        ...
                        <button class="btn btn-primary w-100 mb-3" type="submit" id="resetPasswordButton">
                            <span id="resetSpinner" class="spinner-border spinner-border-sm me-2" role="status" aria-hidden="true" style="display: none;"></span>
                            Set new password
                        </button>
